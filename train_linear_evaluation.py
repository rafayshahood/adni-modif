...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/mnt/ssd2/ClinicNET/log/debug_le_{}.log".format(configuration.seed)),
...
backbone = NNCLR.load_state_dict_(backbone, configuration.le_conf.checkpoint_load)  # load a saved backbone
